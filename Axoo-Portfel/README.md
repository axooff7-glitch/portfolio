...
1. Pobierz plik `AxooPortfel-1.0.0-shaded.jar`.
2. Wrzuć go do folderu `/plugins` na swoim serwerze.
3. Upewnij się, że masz zainstalowane **PlaceholderAPI** i **LuckPerms**.
4. Zrestartuj serwer i skonfiguruj `config.yml` pod swój sklep.
